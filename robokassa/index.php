...
<body>
<div>
    <a href="..">Портфолио</a> &bull; <a href="#">Робокасса</a>
    <hr>
</div>
<form id="payForm" onsubmit="return validateFormAndCalulateSignature()" action='https://merchant.roboxchange.com/Index.aspx' method=POST>
    ...
    Сумма: <input style="margin-bottom: 5px" id="sum" name='OutSum'>
    Номер заказа: <input <input style="margin-bottom: 5px" id="id" name='InvId'>
    Способ оплаты:
    <select name=IncCurrLabel style="margin-bottom: 5px">
    ...
    <script>
        ...
        function calculateSignature() {
            ...
            var password = 'vu1oerOdVBA8XA6OE1Y8';
            var signatureValue = md5(login.value + ":" +  sum.value + ":" + id.value + ":" + password);
